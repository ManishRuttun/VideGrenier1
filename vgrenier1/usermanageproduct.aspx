<%@ Page Title="User Manage Product" Language="C#" MasterPageFile="~/guestmaster.Master" AutoEventWireup="true" CodeBehind="usermanageproduct.aspx.cs" Inherits="vgrenier1.usermangeproduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
 <section style="background-color:#f4efee">
    ...
    <div class="form-horizontal">
        <h2 class=" text-center mt-">View And Manage Product</h2>
        <hr />
