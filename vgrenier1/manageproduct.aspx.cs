...
WebConfigurationManager.ConnectionStrings["VgrenierCS"].ConnectionString;
        ...
        //    cmd.CommandText = "insert into tblProduct (Product_Name, Product_Des, Product_Image, Product_Status, Product_Price, User_Id, Category_Id) values (@Pname, @des, @image, @status, @price, @admin, @cid) ";
