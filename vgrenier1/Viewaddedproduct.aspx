<%@ Page Title="View Added Product" Language="C#" MasterPageFile="~/guestmaster.Master" AutoEventWireup="true" CodeBehind="Viewaddedproduct.aspx.cs" Inherits="vgrenier1.Viewaddedproduct" %>
...
name</asp:Label>
    ...
    <div class="form-group row justify-content-center">
        <div class="offset-md-2 col-md-8">
            <asp:Button runat="server" ID="btnAddmovies" OnClick="btnAddmovies_Click" Text="Add Product"
